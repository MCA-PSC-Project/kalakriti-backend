...
class Orders(Resource):
    ...
    def get(self, order_id):
        ...
        #         SELECT o.id FROM orders o WHERE o.user_id = 3
        #     )
        # )'''
        ...
        ad.id, ad.address, ad.district, ad.city, ad.state, ad.country, ad.pincode, ad.landmark 
        FROM orders o 
        ...
        try:
            ...
            # # app.logger.debug("cursor object: %s", cursor)
            cursor.execute(GET_ORDER, (user_id,))
...
class UserOrders(Resource):
    ...
    def get(self):
        ...
        GET_ORDERS = '''SELECT o.id AS order_id, o.order_status, o.added_at, o.updated_at, 
            temp.order_item_id, temp.product_item_id, temp.product_id, temp.product_name 
            FROM orders o 
            JOIN LATERAL(
                SELECT oi.id AS order_item_id, oi.product_item_id, p.id AS product_id, p.product_name AS product_name
                FROM order_items oi 
                JOIN products p
                ON p.id = (
